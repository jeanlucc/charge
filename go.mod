module github.com/theodo/scalab
...
require (
	...
	github.com/ClickHouse/clickhouse-go v1.3.13 // indirect
	...
	github.com/nakagami/firebirdsql v0.0.0-20191128141720-8048f7ca3088 // indirect
